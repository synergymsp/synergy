...
import FeedbackSection from '@/component/home/feedback/Feedback';
...
export default function HomePage() {
  return (
    <>
      ...
      <section
        id="about-section"
        className="relative py-[60px] md:py-[80px] lg:py-[120px]"
      >
        <AboutSection />
      </section>
      ...
      <section className="relative py-[50px] md:pb-[70px] md:pt-[80px] lg:pb-[90px] lg:pt-[120px] xl:pt-[240px]">
        ...
        <div className="faq-shape2 hidden bg-faq-sec-two bg-cover bg-center bg-no-repeat xl:block"></div>
        <FAQSection />
      </section>

      <section className="mt-[50px] bg-cta-sec bg-cover bg-center bg-no-repeat py-[50px] md:mt-[80px] md:py-[80px] lg:mt-[120px] lg:py-[120px]">
